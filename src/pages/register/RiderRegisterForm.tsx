...
// TH & fallback
const plateRegex = /^(\d{0,2}[ก-ฮ]{1,2}\s?\d{1,4}|[A-Z]{1,3}-?\d{1,4})$/;
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "กรุณากรอกทะเบียนรถ" },
                  {
                    pattern: plateRegex,
                    message:
                      "รูปแบบทะเบียนรถไม่ถูกต้อง (เช่น 1กข 1234 หรือ ABC-1234)",
                  },
                ]}
              >
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} md={24}>
              <Form.Item
                ...
                rules={[
                  { required: true, message: "กรุณาอัปโหลดไฟล์ใบอนุญาตขับขี่" },
                ]}
              >
                <Upload
                  beforeUpload={() => false}
